...
Kruskal-Wallis omnibus **p = 2e-07** — the paper reports p = 3.23e-07 for genus
count, which is remarkably close for a different profiler and a different rank.
...
the paper built a 3.5-million-gene catalogue and used MLG (metagenomic linkage
...
1. **Different profiler.** The paper used MLGs from its own gene catalogue;
